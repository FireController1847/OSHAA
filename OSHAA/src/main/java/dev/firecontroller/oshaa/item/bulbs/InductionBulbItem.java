...
public final class InductionBulbItem extends Item implements OAIEnergyConsumer {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @NotNull TooltipContext context, @NotNull List<Component> tooltipComponents, @NotNull TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(Component.translatable("tooltip.oshaa.item.induction_bulb").withStyle(ChatFormatting.BLUE).withStyle(ChatFormatting.ITALIC));
        tooltipComponents.add(
            Component.translatable(
                "tooltip.oshaa.energy_usage",
                Component.literal(OAConfig.bulbsInductionConsumption.get() + "FE/t").withStyle(ChatFormatting.DARK_GRAY)
