...
public final class HalogenBulbItem extends Item implements OAIEnergyConsumer {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @NotNull TooltipContext context, @NotNull List<Component> tooltipComponents, @NotNull TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(Component.translatable("tooltip.oshaa.item.halogen_bulb").withStyle(ChatFormatting.BLUE).withStyle(ChatFormatting.ITALIC));
        tooltipComponents.add(
            Component.translatable(
                "tooltip.oshaa.energy_usage",
                Component.literal(OAConfig.bulbsHalogenConsumption.get() + "FE/t").withStyle(ChatFormatting.DARK_GRAY)
